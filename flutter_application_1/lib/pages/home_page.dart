        ...
        child: Column(
          ...
          children: [
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: Text("CREATE AWESOME STUFF \n WITH THE WORLD'S GREATEST \n COMIC API", style: TextStyle(color: Colors.white,fontSize: 15), maxLines: 3,),
              )
            ),
          ),
          SizedBox(height: 30)
          ,
           Container(
                ...
                child: Text("The Marvel Comics API allows \n developers everywhere to access \n information about Marvel's vast \n ibrary of comics—from what's \n coming up, to 70 years ago.", style: TextStyle(fontSize: 20), maxLines: 5,),
              ),
              SizedBox(height: 15)
              ,
                 Container(
                ...
                height: 20,
                margin: const EdgeInsets.only(left: 20.0, right: 0.0,top: 20),
                child: Text("START NOW!", style: TextStyle(color: Colors.red,fontSize: 20), maxLines: 5,),
              )
              ,
                 Container(
                width: MediaQuery.of(context).size.width,
                height: 90,
                margin: const EdgeInsets.only(left: 20.0, right: 0.0,top: 20),
                child: Text("To start please click the side-bar \n button to access to all the \n features.", style: TextStyle(color: Colors.black,fontSize: 20), maxLines: 5,),
              )
          ],
